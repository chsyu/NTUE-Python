...
# friends = ...
# If we have 1 local friend and 2 abroad friends, 
# we could calculate the total friends by using `.union`

friends = local.union(abroad)
print(f"union friends = {friends}")
...
# Given these two sets of students, 
# we can calculate those who do both art and science 
# by using `.intersection`

both = art.intersection(science)
print(f"intersection set = {both}")
